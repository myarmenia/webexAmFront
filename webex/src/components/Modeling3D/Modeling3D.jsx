      ...
      <div className="all_sides">
        ...
        <div className="middle_side_under_Slider">
          <div className="middle_side_under_Slider_top_boxes">
            ...
            <div className="middle_side_under_Slider_top_boxes_title_bigDiv">
              <div className="middle_side_under_Slider_top_boxes_title_box">{t('middleSideUnderSlider.1')}</div>
              <div className="middle_side_under_Slider_top_boxes_title_box">{t('middleSideUnderSlider.2')}</div>
              <div className="middle_side_under_Slider_top_boxes_title_box">{t('middleSideUnderSlider.3')}</div>
              <div className="middle_side_under_Slider_top_boxes_title_box">{t('middleSideUnderSlider.4')}</div>
            </div>
          </div>
          {/* /////////////////////// */}
          <div className="create_3d_model">
            <p className="create_3d_model_title">{t('create3dModel.0')}</p>
            <p className="create_3d_model_greenText">
            {t('create3dModel.1')}
            </p>
            <p>
            {t('create3dModel.2')}
            ...
            <p style={{ marginLeft: '20px' }}>
              &bull; {t('create3dModel.3')}
            </p>
            <p style={{ marginLeft: '20px' }}>
              &bull; {t('create3dModel.4')}
            </p>
            <p style={{ marginLeft: '20px' }}>
              &bull; {t('create3dModel.5')}
            </p>
            <p style={{ marginLeft: '20px' }}>
              &bull; {t('create3dModel.6')}
            </p>
          </div>
        </div>
        {/* ////////////////////// */}
        ...
        <div className="bottom_side">
          <div className="bottom_side_textss">
            <p className="bottom_side_p1">
            {t('bottomSideTexts.0')}
            </p>
            <span className="bottom_side_p2">
            {t('bottomSideTexts.1')}
            </span>
            <p className="bottom_side_p3">
            {t('bottomSideTexts.2')}
            </p>
            ...
            <div className="bottom_side_text_div">
              <span className="bottom_side_span1">
              {t('bottomSideTexts.5')}
              </span>
              <span>
              {t('bottomSideTexts.6')}
            ...
            <div className="bottom_side_text_div">
              ...
              <span>
              {t('bottomSideTexts.19')}
              </span>
            </div>
            <div className="bottom_side_text_div">
              <span>
              {t('bottomSideTexts.20')}
              </span>
              <span className="bottom_side_span1"> {t('bottomSideTexts.21')}</span>
            </div>
            <div className="bottom_side_text_div">
              <span className="bottom_side_span1">
              {t('bottomSideTexts.22')}
              </span>
            </div>
            <div className="bottom_side_text_div">
              <span className="bottom_side_span1">
              {t('bottomSideTexts.23')}
              </span>
              <span>
              {t('bottomSideTexts.24')}
              </span>
            </div>
            <div className="bottom_side_text_div">
              <span>{t('bottomSideTexts.25')} </span>
              <span className="bottom_side_span1">
              {t('bottomSideTexts.26')}
              </span>
            </div>
            <div className="bottom_side_text_div">
              <span>
              {t('bottomSideTexts.27')}
              </span>
            </div>
            <div className="bottom_side_text_div">
              <span className="bottom_side_span1">
              {t('bottomSideTexts.28')}
              </span>
            </div>
          </div>
          <div className="buttons_side">
            <p style={{ color: '#414348' }}>{t('buttonsSide.0')}</p>
            <div className="buttons_div">
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.1')}</a>
              </div>
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.2')}</a>
              </div>
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.3')}</a>
              </div>
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.4')}</a>
              </div>
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.5')}</a>
              </div>
              <div className="buttons_div_divs">
                <a href="#">{t('buttonsSide.6')}</a>
              </div>
            </div>
          </div>
        </div>
