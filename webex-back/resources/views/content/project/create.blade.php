        ...
        <form action="{{route('project.add')}}" method="post">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    ...
                    placeholder="Описание Арм." id="proj-am" name="proj-am" value="{{old('proj-am')}}"></textarea>
                </div>
            </div>
            @error('proj-am')
            <div class="mb-3 row justify-content-end">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                    placeholder="Описание Ру." id="proj-ru" name="proj-ru" value="{{old('proj-ru')}}"></textarea>
                </div>
            </div>
            @error('proj-ru')
            <div class="mb-3 row justify-content-end">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-md-10">
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                    placeholder="Описание Анг." id="proj-en" name="proj-en" value="{{old('proj-en')}}"></textarea>
                </div>
            </div>
            @error('proj-en')
            <div class="mb-3 row justify-content-end">
