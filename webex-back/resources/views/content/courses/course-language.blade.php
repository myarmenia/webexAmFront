...
<div class="card">
  ...
  <div class="d-flex justify-content-between align-items-center" >
    <div>
      <h5 class="card-header">Languages Name</h5>
    </div>
    <div>
      <a href="{{route('course-language-create')}}" class="btn btn-primary mx-4">Create </a>
    </div>
  </div>
  <div class="card-body">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          @if (count($course_language)>0)
            ...
            <tr>
              <td><i class="bx bxl-angular bx-sm text-danger me-3"></i> <span class="fw-medium">{{$item->name}}</span></td>
              <td><span class="badge bg-label-primary me-1">Active</span></td>
              <td>
                <div class="dropdown">
                  <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="bx bx-dots-vertical-rounded"></i></button>
